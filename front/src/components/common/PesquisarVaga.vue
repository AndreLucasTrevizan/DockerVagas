        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input v-model="titulo" @change="pesquisarVaga" type="text" class="form-control" placeholder="Pesquise por palavras chaves, por exemplo 'PHP', 'Pleno', 'Analista'">
